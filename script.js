document.addEventListener("DOMContentLoaded", function () {
  ...
  function clearAllFilters() {
    document.querySelectorAll(".sec2-input:checked").forEach((checkbox) => {
  ...
  function clearAllRatings() {
    document.querySelectorAll(".sec4-input:checked").forEach((checkbox) => {
      checkbox.checked = false;
    });
    toggleClearAllRatingsVisibility();
    leftfilterProducts();
  ...
  function clearAllRAMFilters() {
    document.querySelectorAll(".sec6-input:checked").forEach((checkbox) => {
      checkbox.checked = false;
    });
    toggleClearAllRAMVisibility();
    leftfilterProducts();
  ...
  function toggleClearAllRAMVisibility() {
    const removeItemsSec6 = document.querySelector(".sec6-remove-items");
    const checkboxes = document.querySelectorAll(".sec6-input:checked");
    removeItemsSec6.style.display = checkboxes.length > 0 ? "block" : "none";
  }

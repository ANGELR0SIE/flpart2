document.addEventListener("DOMContentLoaded", function () {
  ...
  //     .addEventListener("click", clearAllRAMFilters);
   }
  ...
  // Combined function to toggle visibility or clear all filters
function toggleOrClearAll() {
  const isRAMFiltersActive = checkIfRAMFiltersActive();
  const isRatingsFiltersActive = checkIfRatingsFiltersActive();
  const isOtherFiltersActive = checkIfOtherFiltersActive();

  if (isRAMFiltersActive || isRatingsFiltersActive || isOtherFiltersActive) {
      // Clear all filters
      clearAllRAMFilters();
      clearAllRatings();
      clearAllFilters();
...
// Functions to check if filters are active
function checkIfRAMFiltersActive() {
  // Example logic: Check if any RAM filters are applied
  return document.querySelectorAll('.ram-filter-active').length > 0;
}

function checkIfRatingsFiltersActive() {
  // Example logic: Check if any ratings filters are applied
  return document.querySelectorAll('.ratings-filter-active').length > 0;
}

function checkIfOtherFiltersActive() {
  // Example logic: Check if any other filters are applied
  return document.querySelectorAll('.other-filters-active').length > 0;
}

// Functions to clear filters
function clearAllRAMFilters() {
  // Logic to clear RAM filters
...
function clearAllRatings() {
  // Logic to clear ratings filters
...
function toggleClearAllRatingsVisibility() {
  const elements = document.querySelectorAll('.toggle-ratings-visibility');
  elements.forEach(element => {
      element.style.display = element.style.display === 'none' ? 'block' : 'none';
  });
}

function toggleClearAllRAMVisibility() {
  const elements = document.querySelectorAll('.toggle-ram-visibility');
  elements.forEach(element => {
      element.style.display = element.style.display === 'none' ? 'block' : 'none';
  });
}
